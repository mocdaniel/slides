...
info: A talk about Falco, a cloud-native, real-time anomaly detection engine.
date: 2026-04-28
event: stackconf 2026
...
<img src="./public/nws-badges-new.png" alt="A collection of NWS badges, e.g. ISO27001, KCSP, KCSC, OpenInfra and CNCF member" class="w-96 m-x-auto"/>
...
<img src="./public/falco-kernel-architecture.svg" alt="Figure explaining Falco's negotiation between user- and kernel-space" />
...
<div class="m-l-4 h-full flex justify-center items-center">
  <img class="w-90" src="./public/nms-os-future.svg" alt="Future OpenStack falco setup at NMS" />
</div>
